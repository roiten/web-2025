...
<body>
  ...
  <?php foreach ($posts as $post): ?>
    <div class="publication">
      ...
      <img src="<?php echo $post['post']['img-source'] ?>" alt="Фотография" width="500" class="content-main-photo">
        
      <div class="like">
        <button type="button">❤</button>
        <span class="like-count"><?= $post['post']['likes'] ?></span>
      </div>
        
      <div class="post-description">
        <p class="text-description"><?= $post['post']['post-description'] ?></p>
        <p class="pubtime"><?php echo ($post['post']['publication-time']) ?></p>
      </div>
    </div>
  <?php endforeach; ?>
</body>
